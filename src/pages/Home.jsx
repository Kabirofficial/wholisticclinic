...
import clinicPhoto1 from '../assets/images/clinic-1.jpg';
import clinicPhoto2 from '../assets/images/clinic-2.jpg';
import clinicPhoto3 from '../assets/images/clinic-3.jpg';
    ...
    <div className="home-page">
      ...
      <FadeInOnScroll>
        <section className="clinic-gallery-section">
          <h2 className="section-title">A Glimpse of Our Clinic</h2>
          <p className="section-intro">
            A calm, clean, and welcoming environment for your healing journey.
          </p>
          <div className="photo-grid">
            <div className="photo-item">
              <img src={clinicPhoto1} alt="Clinic Reception Area" />
            </div>
            <div className="photo-item">
              <img src={clinicPhoto2} alt="Consultation Room" />
            </div>
            <div className="photo-item">
              <img src={clinicPhoto3} alt="Wholistic Clinic Environment" />
            </div>
          </div>
        </section>
      </FadeInOnScroll>
